...
/// Search screen 
/// 
class NsSearchScreen extends StatefulWidget {
  const NsSearchScreen({Key? key}) : super(key: key);

  @override
  State<NsSearchScreen> createState() => _NsSearchScreenState();
}

class _NsSearchScreenState extends State<NsSearchScreen> {
 ...
 */     default:
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
       appBar: buildObjectAppBar(context, _scaffoldKey, "Search",
